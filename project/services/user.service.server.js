...
module.exports = function(app, models) {
    ...
    var facebookConfig = {
        clientID     : process.env.FACEBOOK_CLIENT_ID || "316740138782094",
        clientSecret : process.env.FACEBOOK_CLIENT_SECRET || "187b2f40b7bb81f4361bfe1bb60064a0",
    ...
    function localStrategy(username, password, done) {
        ...
        userModel
            ...
            .then(function (user) {
                ...
                return done(null, user);
                var result = bcrypt.compareSync(password, user.password); //compareSync was stalling for unknown reason
